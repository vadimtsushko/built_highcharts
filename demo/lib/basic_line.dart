...
void basicLine(_) {
  ...
  var chartOptions = new ChartOptions((b) => b
    ...
    ..yAxis.plotLines = jsonObject([
      {'value': 0, 'width': 1, 'color': '#808080'}
    ])
    ..tooltip.valueSuffix = 'ºC'
    ..tooltip.shared = false
    ..tooltip.formatter = allowInteropCaptureThis((jsThis, _) {
      var x = js_util.getProperty(jsThis, 'x');
      return '<b>$x<b>';
    })
...
//        ..fillOpacity = 0.2
  ...
  clearSelectionButton = chart.renderer.button('Clear selection', 0, 0,
      allowInterop(clearSelection), null, null, null, null, null);
