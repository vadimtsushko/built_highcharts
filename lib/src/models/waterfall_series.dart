...
part 'waterfall_series.g.dart';
    
abstract class WaterfallSeries implements Series, Built<WaterfallSeries, WaterfallSeriesBuilder> {
  static Serializer<WaterfallSeries> get serializer => _$waterfallSeriesSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the data labels can be styled wtih the <code>.highcharts-data-label-box</code> and <code>.highcharts-data-label</code> class names (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">see example</a>).</p> 
   */
  @nullable
  WaterfallSeriesDataLabels get dataLabels;
  /** 
...
<p>A description of the series to add to the screen reader information about the series.</p> 
   ...
   */
  @nullable
  WaterfallSeriesEvents get events;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the stroke can be set with the <code>.highcharts-graph</code> class.</p> 
   ...
   */
  @nullable
  WaterfallSeriesPoint get point;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the color zones are styled with the <code>.highcharts-zone-{n}</code> class, or custom classed from the <code>className</code> option (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/color-zones/">view live demo</a>).</p> 
  ...
  factory WaterfallSeries([updates(WaterfallSeriesBuilder b)]) = _$WaterfallSeries;
  WaterfallSeries._();
}
abstract class WaterfallSeriesData implements Built<WaterfallSeriesData, WaterfallSeriesDataBuilder> {
  static Serializer<WaterfallSeriesData> get serializer => _$waterfallSeriesDataSerializer;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory WaterfallSeriesData([updates(WaterfallSeriesDataBuilder b)]) = _$WaterfallSeriesData;
  WaterfallSeriesData._();
}
abstract class WaterfallSeriesDataEvents implements Built<WaterfallSeriesDataEvents, WaterfallSeriesDataEventsBuilder> {
  static Serializer<WaterfallSeriesDataEvents> get serializer => _$waterfallSeriesDataEventsSerializer;
  /** 
  ...
  factory WaterfallSeriesDataEvents([updates(WaterfallSeriesDataEventsBuilder b)]) = _$WaterfallSeriesDataEvents;
  WaterfallSeriesDataEvents._();
}
abstract class WaterfallSeriesDataLabels implements Built<WaterfallSeriesDataLabels, WaterfallSeriesDataLabelsBuilder> {
  static Serializer<WaterfallSeriesDataLabels> get serializer => _$waterfallSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory WaterfallSeriesDataLabels([updates(WaterfallSeriesDataLabelsBuilder b)]) = _$WaterfallSeriesDataLabels;
  WaterfallSeriesDataLabels._();
}
abstract class WaterfallSeriesEvents implements Built<WaterfallSeriesEvents, WaterfallSeriesEventsBuilder> {
  static Serializer<WaterfallSeriesEvents> get serializer => _$waterfallSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory WaterfallSeriesEvents([updates(WaterfallSeriesEventsBuilder b)]) = _$WaterfallSeriesEvents;
  WaterfallSeriesEvents._();
}
abstract class WaterfallSeriesPoint implements Built<WaterfallSeriesPoint, WaterfallSeriesPointBuilder> {
  static Serializer<WaterfallSeriesPoint> get serializer => _$waterfallSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  WaterfallSeriesPointEvents get events;
  factory WaterfallSeriesPoint([updates(WaterfallSeriesPointBuilder b)]) = _$WaterfallSeriesPoint;
  WaterfallSeriesPoint._();
}
abstract class WaterfallSeriesPointEvents implements Built<WaterfallSeriesPointEvents, WaterfallSeriesPointEventsBuilder> {
  static Serializer<WaterfallSeriesPointEvents> get serializer => _$waterfallSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory WaterfallSeriesPointEvents([updates(WaterfallSeriesPointEventsBuilder b)]) = _$WaterfallSeriesPointEvents;
  WaterfallSeriesPointEvents._();
}
abstract class WaterfallSeriesStates implements Built<WaterfallSeriesStates, WaterfallSeriesStatesBuilder> {
  static Serializer<WaterfallSeriesStates> get serializer => _$waterfallSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  WaterfallSeriesStatesHover get hover;
  factory WaterfallSeriesStates([updates(WaterfallSeriesStatesBuilder b)]) = _$WaterfallSeriesStates;
  WaterfallSeriesStates._();
}
abstract class WaterfallSeriesStatesHover implements Built<WaterfallSeriesStatesHover, WaterfallSeriesStatesHoverBuilder> {
  static Serializer<WaterfallSeriesStatesHover> get serializer => _$waterfallSeriesStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @nullable
  JsonObject get halo;
  factory WaterfallSeriesStatesHover([updates(WaterfallSeriesStatesHoverBuilder b)]) = _$WaterfallSeriesStatesHover;
  WaterfallSeriesStatesHover._();
}
abstract class WaterfallSeriesStatesHoverHalo implements Built<WaterfallSeriesStatesHoverHalo, WaterfallSeriesStatesHoverHaloBuilder> {
  static Serializer<WaterfallSeriesStatesHoverHalo> get serializer => _$waterfallSeriesStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory WaterfallSeriesStatesHoverHalo([updates(WaterfallSeriesStatesHoverHaloBuilder b)]) = _$WaterfallSeriesStatesHoverHalo;
  WaterfallSeriesStatesHoverHalo._();
}
abstract class WaterfallSeriesTooltip implements Built<WaterfallSeriesTooltip, WaterfallSeriesTooltipBuilder> {
  static Serializer<WaterfallSeriesTooltip> get serializer => _$waterfallSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory WaterfallSeriesTooltip([updates(WaterfallSeriesTooltipBuilder b)]) = _$WaterfallSeriesTooltip;
  WaterfallSeriesTooltip._();
}
abstract class WaterfallSeriesZones implements Built<WaterfallSeriesZones, WaterfallSeriesZonesBuilder> {
  static Serializer<WaterfallSeriesZones> get serializer => _$waterfallSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory WaterfallSeriesZones([updates(WaterfallSeriesZonesBuilder b)]) = _$WaterfallSeriesZones;
  WaterfallSeriesZones._();
}
