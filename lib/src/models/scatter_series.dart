...
part 'scatter_series.g.dart';
    
abstract class ScatterSeries implements Series, Built<ScatterSeries, ScatterSeriesBuilder> {
  static Serializer<ScatterSeries> get serializer => _$scatterSeriesSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the data labels can be styled wtih the <code>.highcharts-data-label-box</code> and <code>.highcharts-data-label</code> class names (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">see example</a>).</p> 
   */
  @nullable
  ScatterSeriesDataLabels get dataLabels;
  /** 
...
<p>A description of the series to add to the screen reader information about the series.</p> 
   ...
   */
  @nullable
  ScatterSeriesEvents get events;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the markers can be styled with the <code>.highcharts-point</code>, <code>.highcharts-point-hover</code> and <code>.highcharts-point-select</code> class names.</p> 
   */
  @nullable
  ScatterSeriesMarker get marker;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the color zones are styled with the <code>.highcharts-zone-{n}</code> class, or custom classed from the <code>className</code> option (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/color-zones/">view live demo</a>).</p> 
  ...
  factory ScatterSeries([updates(ScatterSeriesBuilder b)]) = _$ScatterSeries;
  ScatterSeries._();
}
abstract class ScatterSeriesData implements Built<ScatterSeriesData, ScatterSeriesDataBuilder> {
  static Serializer<ScatterSeriesData> get serializer => _$scatterSeriesDataSerializer;
  /** 
...
<p>A description of the point to add to the screen reader information about the point.</p> 
   ...
   */
  @nullable
  ScatterSeriesDataMarker get marker;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory ScatterSeriesData([updates(ScatterSeriesDataBuilder b)]) = _$ScatterSeriesData;
  ScatterSeriesData._();
}
abstract class ScatterSeriesDataEvents implements Built<ScatterSeriesDataEvents, ScatterSeriesDataEventsBuilder> {
  static Serializer<ScatterSeriesDataEvents> get serializer => _$scatterSeriesDataEventsSerializer;
  /** 
  ...
  factory ScatterSeriesDataEvents([updates(ScatterSeriesDataEventsBuilder b)]) = _$ScatterSeriesDataEvents;
  ScatterSeriesDataEvents._();
}
abstract class ScatterSeriesDataMarker implements Built<ScatterSeriesDataMarker, ScatterSeriesDataMarkerBuilder> {
  static Serializer<ScatterSeriesDataMarker> get serializer => _$scatterSeriesDataMarkerSerializer;
  /** 
   ...
   */
  @nullable
  ScatterSeriesDataMarkerStates get states;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory ScatterSeriesDataMarker([updates(ScatterSeriesDataMarkerBuilder b)]) = _$ScatterSeriesDataMarker;
  ScatterSeriesDataMarker._();
}
abstract class ScatterSeriesDataMarkerStates implements Built<ScatterSeriesDataMarkerStates, ScatterSeriesDataMarkerStatesBuilder> {
  static Serializer<ScatterSeriesDataMarkerStates> get serializer => _$scatterSeriesDataMarkerStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  ScatterSeriesDataMarkerStatesHover get hover;
  factory ScatterSeriesDataMarkerStates([updates(ScatterSeriesDataMarkerStatesBuilder b)]) = _$ScatterSeriesDataMarkerStates;
  ScatterSeriesDataMarkerStates._();
}
abstract class ScatterSeriesDataMarkerStatesHover implements Built<ScatterSeriesDataMarkerStatesHover, ScatterSeriesDataMarkerStatesHoverBuilder> {
  static Serializer<ScatterSeriesDataMarkerStatesHover> get serializer => _$scatterSeriesDataMarkerStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  ScatterSeriesDataMarkerStatesHoverMarker get marker;
  @deprecated
  factory ScatterSeriesDataMarkerStatesHover([updates(ScatterSeriesDataMarkerStatesHoverBuilder b)]) = _$ScatterSeriesDataMarkerStatesHover;
  ScatterSeriesDataMarkerStatesHover._();
}
abstract class ScatterSeriesDataMarkerStatesHoverHalo implements Built<ScatterSeriesDataMarkerStatesHoverHalo, ScatterSeriesDataMarkerStatesHoverHaloBuilder> {
  static Serializer<ScatterSeriesDataMarkerStatesHoverHalo> get serializer => _$scatterSeriesDataMarkerStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory ScatterSeriesDataMarkerStatesHoverHalo([updates(ScatterSeriesDataMarkerStatesHoverHaloBuilder b)]) = _$ScatterSeriesDataMarkerStatesHoverHalo;
  ScatterSeriesDataMarkerStatesHoverHalo._();
}
abstract class ScatterSeriesDataMarkerStatesHoverMarker implements Built<ScatterSeriesDataMarkerStatesHoverMarker, ScatterSeriesDataMarkerStatesHoverMarkerBuilder> {
  static Serializer<ScatterSeriesDataMarkerStatesHoverMarker> get serializer => _$scatterSeriesDataMarkerStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory ScatterSeriesDataMarkerStatesHoverMarker([updates(ScatterSeriesDataMarkerStatesHoverMarkerBuilder b)]) = _$ScatterSeriesDataMarkerStatesHoverMarker;
  ScatterSeriesDataMarkerStatesHoverMarker._();
}
abstract class ScatterSeriesDataLabels implements Built<ScatterSeriesDataLabels, ScatterSeriesDataLabelsBuilder> {
  static Serializer<ScatterSeriesDataLabels> get serializer => _$scatterSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory ScatterSeriesDataLabels([updates(ScatterSeriesDataLabelsBuilder b)]) = _$ScatterSeriesDataLabels;
  ScatterSeriesDataLabels._();
}
abstract class ScatterSeriesEvents implements Built<ScatterSeriesEvents, ScatterSeriesEventsBuilder> {
  static Serializer<ScatterSeriesEvents> get serializer => _$scatterSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory ScatterSeriesEvents([updates(ScatterSeriesEventsBuilder b)]) = _$ScatterSeriesEvents;
  ScatterSeriesEvents._();
}
abstract class ScatterSeriesMarker implements Built<ScatterSeriesMarker, ScatterSeriesMarkerBuilder> {
  static Serializer<ScatterSeriesMarker> get serializer => _$scatterSeriesMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
   ...
   */
  @nullable
  ScatterSeriesMarkerStates get states;
  /** 
   * <p>A predefined shape or symbol for the marker. When null, the symbol is pulled from options.symbols. Other possible values are "circle", "square", "diamond", "triangle" and "triangle-down".</p>
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory ScatterSeriesMarker([updates(ScatterSeriesMarkerBuilder b)]) = _$ScatterSeriesMarker;
  ScatterSeriesMarker._();
}
abstract class ScatterSeriesMarkerStates implements Built<ScatterSeriesMarkerStates, ScatterSeriesMarkerStatesBuilder> {
  static Serializer<ScatterSeriesMarkerStates> get serializer => _$scatterSeriesMarkerStatesSerializer;
  /** 
   * null 
   */
  @nullable
  ScatterSeriesMarkerStatesHover get hover;
  /** 
   * The appearance of the point marker when selected. In order to allow a point to be 
		selected, set the <code>series.allowPointSelect</code> option to true. 
   */
  @nullable
  ScatterSeriesMarkerStatesSelect get select;
  factory ScatterSeriesMarkerStates([updates(ScatterSeriesMarkerStatesBuilder b)]) = _$ScatterSeriesMarkerStates;
  ScatterSeriesMarkerStates._();
}
abstract class ScatterSeriesMarkerStatesHover implements Built<ScatterSeriesMarkerStatesHover, ScatterSeriesMarkerStatesHoverBuilder> {
  static Serializer<ScatterSeriesMarkerStatesHover> get serializer => _$scatterSeriesMarkerStatesHoverSerializer;
  /** 
  ...
  @nullable
  num get radiusPlus;
  factory ScatterSeriesMarkerStatesHover([updates(ScatterSeriesMarkerStatesHoverBuilder b)]) = _$ScatterSeriesMarkerStatesHover;
  ScatterSeriesMarkerStatesHover._();
}
abstract class ScatterSeriesMarkerStatesSelect implements Built<ScatterSeriesMarkerStatesSelect, ScatterSeriesMarkerStatesSelectBuilder> {
  static Serializer<ScatterSeriesMarkerStatesSelect> get serializer => _$scatterSeriesMarkerStatesSelectSerializer;
  /** 
  ...
  @nullable
  num get radius;
  factory ScatterSeriesMarkerStatesSelect([updates(ScatterSeriesMarkerStatesSelectBuilder b)]) = _$ScatterSeriesMarkerStatesSelect;
  ScatterSeriesMarkerStatesSelect._();
}
abstract class ScatterSeriesPoint implements Built<ScatterSeriesPoint, ScatterSeriesPointBuilder> {
  static Serializer<ScatterSeriesPoint> get serializer => _$scatterSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  ScatterSeriesPointEvents get events;
  factory ScatterSeriesPoint([updates(ScatterSeriesPointBuilder b)]) = _$ScatterSeriesPoint;
  ScatterSeriesPoint._();
}
abstract class ScatterSeriesPointEvents implements Built<ScatterSeriesPointEvents, ScatterSeriesPointEventsBuilder> {
  static Serializer<ScatterSeriesPointEvents> get serializer => _$scatterSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory ScatterSeriesPointEvents([updates(ScatterSeriesPointEventsBuilder b)]) = _$ScatterSeriesPointEvents;
  ScatterSeriesPointEvents._();
}
abstract class ScatterSeriesStates implements Built<ScatterSeriesStates, ScatterSeriesStatesBuilder> {
  static Serializer<ScatterSeriesStates> get serializer => _$scatterSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  ScatterSeriesStatesHover get hover;
  factory ScatterSeriesStates([updates(ScatterSeriesStatesBuilder b)]) = _$ScatterSeriesStates;
  ScatterSeriesStates._();
}
abstract class ScatterSeriesStatesHover implements Built<ScatterSeriesStatesHover, ScatterSeriesStatesHoverBuilder> {
  static Serializer<ScatterSeriesStatesHover> get serializer => _$scatterSeriesStatesHoverSerializer;
  /** 
   * Animation setting for hovering the graph in line-type series. 
   */
  @nullable
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  ScatterSeriesStatesHoverMarker get marker;
  @deprecated
  factory ScatterSeriesStatesHover([updates(ScatterSeriesStatesHoverBuilder b)]) = _$ScatterSeriesStatesHover;
  ScatterSeriesStatesHover._();
}
abstract class ScatterSeriesStatesHoverHalo implements Built<ScatterSeriesStatesHoverHalo, ScatterSeriesStatesHoverHaloBuilder> {
  static Serializer<ScatterSeriesStatesHoverHalo> get serializer => _$scatterSeriesStatesHoverHaloSerializer;
  /** 
   * A collection of SVG attributes to override the appearance of the halo, for example <code>fill</code>, <code>stroke</code> and <code>stroke-width</code>. 
   */
  @nullable
  ...
  @nullable
  num get size;
  factory ScatterSeriesStatesHoverHalo([updates(ScatterSeriesStatesHoverHaloBuilder b)]) = _$ScatterSeriesStatesHoverHalo;
  ScatterSeriesStatesHoverHalo._();
}
abstract class ScatterSeriesStatesHoverMarker implements Built<ScatterSeriesStatesHoverMarker, ScatterSeriesStatesHoverMarkerBuilder> {
  static Serializer<ScatterSeriesStatesHoverMarker> get serializer => _$scatterSeriesStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory ScatterSeriesStatesHoverMarker([updates(ScatterSeriesStatesHoverMarkerBuilder b)]) = _$ScatterSeriesStatesHoverMarker;
  ScatterSeriesStatesHoverMarker._();
}
abstract class ScatterSeriesTooltip implements Built<ScatterSeriesTooltip, ScatterSeriesTooltipBuilder> {
  static Serializer<ScatterSeriesTooltip> get serializer => _$scatterSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory ScatterSeriesTooltip([updates(ScatterSeriesTooltipBuilder b)]) = _$ScatterSeriesTooltip;
  ScatterSeriesTooltip._();
}
abstract class ScatterSeriesZones implements Built<ScatterSeriesZones, ScatterSeriesZonesBuilder> {
  static Serializer<ScatterSeriesZones> get serializer => _$scatterSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory ScatterSeriesZones([updates(ScatterSeriesZonesBuilder b)]) = _$ScatterSeriesZones;
  ScatterSeriesZones._();
}
