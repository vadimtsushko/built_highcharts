...
abstract class BarSeries implements Series, Built<BarSeries, BarSeriesBuilder> {
  static Serializer<BarSeries> get serializer => _$barSeriesSerializer;
  /** 
...
<pre>data: [{
   ...
   */
  @nullable
  BarSeriesDataLabels get dataLabels;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the color zones are styled with the <code>.highcharts-zone-{n}</code> class, or custom classed from the <code>className</code> option (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/color-zones/">view live demo</a>).</p> 
  ...
  factory BarSeries([updates(BarSeriesBuilder b)]) = _$BarSeries;
  BarSeries._();
}
abstract class BarSeriesData implements Built<BarSeriesData, BarSeriesDataBuilder> {
  static Serializer<BarSeriesData> get serializer => _$barSeriesDataSerializer;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory BarSeriesData([updates(BarSeriesDataBuilder b)]) = _$BarSeriesData;
  BarSeriesData._();
}
abstract class BarSeriesDataEvents implements Built<BarSeriesDataEvents, BarSeriesDataEventsBuilder> {
  static Serializer<BarSeriesDataEvents> get serializer => _$barSeriesDataEventsSerializer;
  /** 
  ...
  factory BarSeriesDataEvents([updates(BarSeriesDataEventsBuilder b)]) = _$BarSeriesDataEvents;
  BarSeriesDataEvents._();
}
abstract class BarSeriesDataLabels implements Built<BarSeriesDataLabels, BarSeriesDataLabelsBuilder> {
  static Serializer<BarSeriesDataLabels> get serializer => _$barSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory BarSeriesDataLabels([updates(BarSeriesDataLabelsBuilder b)]) = _$BarSeriesDataLabels;
  BarSeriesDataLabels._();
}
abstract class BarSeriesEvents implements Built<BarSeriesEvents, BarSeriesEventsBuilder> {
  static Serializer<BarSeriesEvents> get serializer => _$barSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory BarSeriesEvents([updates(BarSeriesEventsBuilder b)]) = _$BarSeriesEvents;
  BarSeriesEvents._();
}
abstract class BarSeriesPoint implements Built<BarSeriesPoint, BarSeriesPointBuilder> {
  static Serializer<BarSeriesPoint> get serializer => _$barSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  BarSeriesPointEvents get events;
  factory BarSeriesPoint([updates(BarSeriesPointBuilder b)]) = _$BarSeriesPoint;
  BarSeriesPoint._();
}
abstract class BarSeriesPointEvents implements Built<BarSeriesPointEvents, BarSeriesPointEventsBuilder> {
  static Serializer<BarSeriesPointEvents> get serializer => _$barSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory BarSeriesPointEvents([updates(BarSeriesPointEventsBuilder b)]) = _$BarSeriesPointEvents;
  BarSeriesPointEvents._();
}
abstract class BarSeriesStates implements Built<BarSeriesStates, BarSeriesStatesBuilder> {
  static Serializer<BarSeriesStates> get serializer => _$barSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  BarSeriesStatesHover get hover;
  factory BarSeriesStates([updates(BarSeriesStatesBuilder b)]) = _$BarSeriesStates;
  BarSeriesStates._();
}
abstract class BarSeriesStatesHover implements Built<BarSeriesStatesHover, BarSeriesStatesHoverBuilder> {
  static Serializer<BarSeriesStatesHover> get serializer => _$barSeriesStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @nullable
  JsonObject get halo;
  factory BarSeriesStatesHover([updates(BarSeriesStatesHoverBuilder b)]) = _$BarSeriesStatesHover;
  BarSeriesStatesHover._();
}
abstract class BarSeriesStatesHoverHalo implements Built<BarSeriesStatesHoverHalo, BarSeriesStatesHoverHaloBuilder> {
  static Serializer<BarSeriesStatesHoverHalo> get serializer => _$barSeriesStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory BarSeriesStatesHoverHalo([updates(BarSeriesStatesHoverHaloBuilder b)]) = _$BarSeriesStatesHoverHalo;
  BarSeriesStatesHoverHalo._();
}
abstract class BarSeriesTooltip implements Built<BarSeriesTooltip, BarSeriesTooltipBuilder> {
  static Serializer<BarSeriesTooltip> get serializer => _$barSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory BarSeriesTooltip([updates(BarSeriesTooltipBuilder b)]) = _$BarSeriesTooltip;
  BarSeriesTooltip._();
}
abstract class BarSeriesZones implements Built<BarSeriesZones, BarSeriesZonesBuilder> {
  static Serializer<BarSeriesZones> get serializer => _$barSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory BarSeriesZones([updates(BarSeriesZonesBuilder b)]) = _$BarSeriesZones;
  BarSeriesZones._();
}
