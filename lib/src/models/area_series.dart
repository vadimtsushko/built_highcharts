...
abstract class AreaSeries implements Series, Built<AreaSeries, AreaSeriesBuilder> {
  static Serializer<AreaSeries> get serializer => _$areaSeriesSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the data labels can be styled wtih the <code>.highcharts-data-label-box</code> and <code>.highcharts-data-label</code> class names (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">see example</a>).</p> 
   */
  @nullable
  AreaSeriesDataLabels get dataLabels;
  /** 
...
abstract class AreaSeriesData implements Built<AreaSeriesData, AreaSeriesDataBuilder> {
  static Serializer<AreaSeriesData> get serializer => _$areaSeriesDataSerializer;
  /** 
...
<p>A description of the point to add to the screen reader information about the point.</p> 
   ...
   */
  @nullable
  AreaSeriesDataMarker get marker;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory AreaSeriesData([updates(AreaSeriesDataBuilder b)]) = _$AreaSeriesData;
  AreaSeriesData._();
}
abstract class AreaSeriesDataEvents implements Built<AreaSeriesDataEvents, AreaSeriesDataEventsBuilder> {
  static Serializer<AreaSeriesDataEvents> get serializer => _$areaSeriesDataEventsSerializer;
  /** 
  ...
  factory AreaSeriesDataEvents([updates(AreaSeriesDataEventsBuilder b)]) = _$AreaSeriesDataEvents;
  AreaSeriesDataEvents._();
}
abstract class AreaSeriesDataMarker implements Built<AreaSeriesDataMarker, AreaSeriesDataMarkerBuilder> {
  static Serializer<AreaSeriesDataMarker> get serializer => _$areaSeriesDataMarkerSerializer;
  /** 
   ...
   */
  @nullable
  AreaSeriesDataMarkerStates get states;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreaSeriesDataMarker([updates(AreaSeriesDataMarkerBuilder b)]) = _$AreaSeriesDataMarker;
  AreaSeriesDataMarker._();
}
abstract class AreaSeriesDataMarkerStates implements Built<AreaSeriesDataMarkerStates, AreaSeriesDataMarkerStatesBuilder> {
  static Serializer<AreaSeriesDataMarkerStates> get serializer => _$areaSeriesDataMarkerStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  AreaSeriesDataMarkerStatesHover get hover;
  factory AreaSeriesDataMarkerStates([updates(AreaSeriesDataMarkerStatesBuilder b)]) = _$AreaSeriesDataMarkerStates;
  AreaSeriesDataMarkerStates._();
}
abstract class AreaSeriesDataMarkerStatesHover implements Built<AreaSeriesDataMarkerStatesHover, AreaSeriesDataMarkerStatesHoverBuilder> {
  static Serializer<AreaSeriesDataMarkerStatesHover> get serializer => _$areaSeriesDataMarkerStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  AreaSeriesDataMarkerStatesHoverMarker get marker;
  @deprecated
  factory AreaSeriesDataMarkerStatesHover([updates(AreaSeriesDataMarkerStatesHoverBuilder b)]) = _$AreaSeriesDataMarkerStatesHover;
  AreaSeriesDataMarkerStatesHover._();
}
abstract class AreaSeriesDataMarkerStatesHoverHalo implements Built<AreaSeriesDataMarkerStatesHoverHalo, AreaSeriesDataMarkerStatesHoverHaloBuilder> {
  static Serializer<AreaSeriesDataMarkerStatesHoverHalo> get serializer => _$areaSeriesDataMarkerStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory AreaSeriesDataMarkerStatesHoverHalo([updates(AreaSeriesDataMarkerStatesHoverHaloBuilder b)]) = _$AreaSeriesDataMarkerStatesHoverHalo;
  AreaSeriesDataMarkerStatesHoverHalo._();
}
abstract class AreaSeriesDataMarkerStatesHoverMarker implements Built<AreaSeriesDataMarkerStatesHoverMarker, AreaSeriesDataMarkerStatesHoverMarkerBuilder> {
  static Serializer<AreaSeriesDataMarkerStatesHoverMarker> get serializer => _$areaSeriesDataMarkerStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreaSeriesDataMarkerStatesHoverMarker([updates(AreaSeriesDataMarkerStatesHoverMarkerBuilder b)]) = _$AreaSeriesDataMarkerStatesHoverMarker;
  AreaSeriesDataMarkerStatesHoverMarker._();
}
abstract class AreaSeriesDataLabels implements Built<AreaSeriesDataLabels, AreaSeriesDataLabelsBuilder> {
  static Serializer<AreaSeriesDataLabels> get serializer => _$areaSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory AreaSeriesDataLabels([updates(AreaSeriesDataLabelsBuilder b)]) = _$AreaSeriesDataLabels;
  AreaSeriesDataLabels._();
}
abstract class AreaSeriesEvents implements Built<AreaSeriesEvents, AreaSeriesEventsBuilder> {
  static Serializer<AreaSeriesEvents> get serializer => _$areaSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory AreaSeriesEvents([updates(AreaSeriesEventsBuilder b)]) = _$AreaSeriesEvents;
  AreaSeriesEvents._();
}
abstract class AreaSeriesMarker implements Built<AreaSeriesMarker, AreaSeriesMarkerBuilder> {
  static Serializer<AreaSeriesMarker> get serializer => _$areaSeriesMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
   ...
   */
  @nullable
  AreaSeriesMarkerStates get states;
  /** 
   * <p>A predefined shape or symbol for the marker. When null, the symbol is pulled from options.symbols. Other possible values are "circle", "square", "diamond", "triangle" and "triangle-down".</p>
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreaSeriesMarker([updates(AreaSeriesMarkerBuilder b)]) = _$AreaSeriesMarker;
  AreaSeriesMarker._();
}
abstract class AreaSeriesMarkerStates implements Built<AreaSeriesMarkerStates, AreaSeriesMarkerStatesBuilder> {
  static Serializer<AreaSeriesMarkerStates> get serializer => _$areaSeriesMarkerStatesSerializer;
  /** 
   * null 
   */
  @nullable
  AreaSeriesMarkerStatesHover get hover;
  /** 
   * The appearance of the point marker when selected. In order to allow a point to be 
		selected, set the <code>series.allowPointSelect</code> option to true. 
   */
  @nullable
  AreaSeriesMarkerStatesSelect get select;
  factory AreaSeriesMarkerStates([updates(AreaSeriesMarkerStatesBuilder b)]) = _$AreaSeriesMarkerStates;
  AreaSeriesMarkerStates._();
}
abstract class AreaSeriesMarkerStatesHover implements Built<AreaSeriesMarkerStatesHover, AreaSeriesMarkerStatesHoverBuilder> {
  static Serializer<AreaSeriesMarkerStatesHover> get serializer => _$areaSeriesMarkerStatesHoverSerializer;
  /** 
  ...
  @nullable
  num get radiusPlus;
  factory AreaSeriesMarkerStatesHover([updates(AreaSeriesMarkerStatesHoverBuilder b)]) = _$AreaSeriesMarkerStatesHover;
  AreaSeriesMarkerStatesHover._();
}
abstract class AreaSeriesMarkerStatesSelect implements Built<AreaSeriesMarkerStatesSelect, AreaSeriesMarkerStatesSelectBuilder> {
  static Serializer<AreaSeriesMarkerStatesSelect> get serializer => _$areaSeriesMarkerStatesSelectSerializer;
  /** 
  ...
  @nullable
  num get radius;
  factory AreaSeriesMarkerStatesSelect([updates(AreaSeriesMarkerStatesSelectBuilder b)]) = _$AreaSeriesMarkerStatesSelect;
  AreaSeriesMarkerStatesSelect._();
}
abstract class AreaSeriesPoint implements Built<AreaSeriesPoint, AreaSeriesPointBuilder> {
  static Serializer<AreaSeriesPoint> get serializer => _$areaSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  AreaSeriesPointEvents get events;
  factory AreaSeriesPoint([updates(AreaSeriesPointBuilder b)]) = _$AreaSeriesPoint;
  AreaSeriesPoint._();
}
abstract class AreaSeriesPointEvents implements Built<AreaSeriesPointEvents, AreaSeriesPointEventsBuilder> {
  static Serializer<AreaSeriesPointEvents> get serializer => _$areaSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory AreaSeriesPointEvents([updates(AreaSeriesPointEventsBuilder b)]) = _$AreaSeriesPointEvents;
  AreaSeriesPointEvents._();
}
abstract class AreaSeriesStates implements Built<AreaSeriesStates, AreaSeriesStatesBuilder> {
  static Serializer<AreaSeriesStates> get serializer => _$areaSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  AreaSeriesStatesHover get hover;
  factory AreaSeriesStates([updates(AreaSeriesStatesBuilder b)]) = _$AreaSeriesStates;
  AreaSeriesStates._();
}
abstract class AreaSeriesStatesHover implements Built<AreaSeriesStatesHover, AreaSeriesStatesHoverBuilder> {
  static Serializer<AreaSeriesStatesHover> get serializer => _$areaSeriesStatesHoverSerializer;
  /** 
   * Animation setting for hovering the graph in line-type series. 
   */
  @nullable
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  AreaSeriesStatesHoverMarker get marker;
  @deprecated
  factory AreaSeriesStatesHover([updates(AreaSeriesStatesHoverBuilder b)]) = _$AreaSeriesStatesHover;
  AreaSeriesStatesHover._();
}
abstract class AreaSeriesStatesHoverHalo implements Built<AreaSeriesStatesHoverHalo, AreaSeriesStatesHoverHaloBuilder> {
  static Serializer<AreaSeriesStatesHoverHalo> get serializer => _$areaSeriesStatesHoverHaloSerializer;
  /** 
   * A collection of SVG attributes to override the appearance of the halo, for example <code>fill</code>, <code>stroke</code> and <code>stroke-width</code>. 
   */
  @nullable
  ...
  @nullable
  num get size;
  factory AreaSeriesStatesHoverHalo([updates(AreaSeriesStatesHoverHaloBuilder b)]) = _$AreaSeriesStatesHoverHalo;
  AreaSeriesStatesHoverHalo._();
}
abstract class AreaSeriesStatesHoverMarker implements Built<AreaSeriesStatesHoverMarker, AreaSeriesStatesHoverMarkerBuilder> {
  static Serializer<AreaSeriesStatesHoverMarker> get serializer => _$areaSeriesStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreaSeriesStatesHoverMarker([updates(AreaSeriesStatesHoverMarkerBuilder b)]) = _$AreaSeriesStatesHoverMarker;
  AreaSeriesStatesHoverMarker._();
}
abstract class AreaSeriesTooltip implements Built<AreaSeriesTooltip, AreaSeriesTooltipBuilder> {
  static Serializer<AreaSeriesTooltip> get serializer => _$areaSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory AreaSeriesTooltip([updates(AreaSeriesTooltipBuilder b)]) = _$AreaSeriesTooltip;
  AreaSeriesTooltip._();
}
abstract class AreaSeriesZones implements Built<AreaSeriesZones, AreaSeriesZonesBuilder> {
  static Serializer<AreaSeriesZones> get serializer => _$areaSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory AreaSeriesZones([updates(AreaSeriesZonesBuilder b)]) = _$AreaSeriesZones;
  AreaSeriesZones._();
}
