...
part 'spline_series.g.dart';
    
abstract class SplineSeries implements Series, Built<SplineSeries, SplineSeriesBuilder> {
  static Serializer<SplineSeries> get serializer => _$splineSeriesSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the data labels can be styled wtih the <code>.highcharts-data-label-box</code> and <code>.highcharts-data-label</code> class names (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">see example</a>).</p> 
   */
  @nullable
  SplineSeriesDataLabels get dataLabels;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the color zones are styled with the <code>.highcharts-zone-{n}</code> class, or custom classed from the <code>className</code> option (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/color-zones/">view live demo</a>).</p> 
  ...
  factory SplineSeries([updates(SplineSeriesBuilder b)]) = _$SplineSeries;
  SplineSeries._();
}
abstract class SplineSeriesData implements Built<SplineSeriesData, SplineSeriesDataBuilder> {
  static Serializer<SplineSeriesData> get serializer => _$splineSeriesDataSerializer;
  /** 
...
<p>A description of the point to add to the screen reader information about the point.</p> 
   ...
   */
  @nullable
  SplineSeriesDataMarker get marker;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory SplineSeriesData([updates(SplineSeriesDataBuilder b)]) = _$SplineSeriesData;
  SplineSeriesData._();
}
abstract class SplineSeriesDataEvents implements Built<SplineSeriesDataEvents, SplineSeriesDataEventsBuilder> {
  static Serializer<SplineSeriesDataEvents> get serializer => _$splineSeriesDataEventsSerializer;
  /** 
  ...
  factory SplineSeriesDataEvents([updates(SplineSeriesDataEventsBuilder b)]) = _$SplineSeriesDataEvents;
  SplineSeriesDataEvents._();
}
abstract class SplineSeriesDataMarker implements Built<SplineSeriesDataMarker, SplineSeriesDataMarkerBuilder> {
  static Serializer<SplineSeriesDataMarker> get serializer => _$splineSeriesDataMarkerSerializer;
  /** 
   ...
   */
  @nullable
  SplineSeriesDataMarkerStates get states;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory SplineSeriesDataMarker([updates(SplineSeriesDataMarkerBuilder b)]) = _$SplineSeriesDataMarker;
  SplineSeriesDataMarker._();
}
abstract class SplineSeriesDataMarkerStates implements Built<SplineSeriesDataMarkerStates, SplineSeriesDataMarkerStatesBuilder> {
  static Serializer<SplineSeriesDataMarkerStates> get serializer => _$splineSeriesDataMarkerStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  SplineSeriesDataMarkerStatesHover get hover;
  factory SplineSeriesDataMarkerStates([updates(SplineSeriesDataMarkerStatesBuilder b)]) = _$SplineSeriesDataMarkerStates;
  SplineSeriesDataMarkerStates._();
}
abstract class SplineSeriesDataMarkerStatesHover implements Built<SplineSeriesDataMarkerStatesHover, SplineSeriesDataMarkerStatesHoverBuilder> {
  static Serializer<SplineSeriesDataMarkerStatesHover> get serializer => _$splineSeriesDataMarkerStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  SplineSeriesDataMarkerStatesHoverMarker get marker;
  @deprecated
  factory SplineSeriesDataMarkerStatesHover([updates(SplineSeriesDataMarkerStatesHoverBuilder b)]) = _$SplineSeriesDataMarkerStatesHover;
  SplineSeriesDataMarkerStatesHover._();
}
abstract class SplineSeriesDataMarkerStatesHoverHalo implements Built<SplineSeriesDataMarkerStatesHoverHalo, SplineSeriesDataMarkerStatesHoverHaloBuilder> {
  static Serializer<SplineSeriesDataMarkerStatesHoverHalo> get serializer => _$splineSeriesDataMarkerStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory SplineSeriesDataMarkerStatesHoverHalo([updates(SplineSeriesDataMarkerStatesHoverHaloBuilder b)]) = _$SplineSeriesDataMarkerStatesHoverHalo;
  SplineSeriesDataMarkerStatesHoverHalo._();
}
abstract class SplineSeriesDataMarkerStatesHoverMarker implements Built<SplineSeriesDataMarkerStatesHoverMarker, SplineSeriesDataMarkerStatesHoverMarkerBuilder> {
  static Serializer<SplineSeriesDataMarkerStatesHoverMarker> get serializer => _$splineSeriesDataMarkerStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory SplineSeriesDataMarkerStatesHoverMarker([updates(SplineSeriesDataMarkerStatesHoverMarkerBuilder b)]) = _$SplineSeriesDataMarkerStatesHoverMarker;
  SplineSeriesDataMarkerStatesHoverMarker._();
}
abstract class SplineSeriesDataLabels implements Built<SplineSeriesDataLabels, SplineSeriesDataLabelsBuilder> {
  static Serializer<SplineSeriesDataLabels> get serializer => _$splineSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory SplineSeriesDataLabels([updates(SplineSeriesDataLabelsBuilder b)]) = _$SplineSeriesDataLabels;
  SplineSeriesDataLabels._();
}
abstract class SplineSeriesEvents implements Built<SplineSeriesEvents, SplineSeriesEventsBuilder> {
  static Serializer<SplineSeriesEvents> get serializer => _$splineSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory SplineSeriesEvents([updates(SplineSeriesEventsBuilder b)]) = _$SplineSeriesEvents;
  SplineSeriesEvents._();
}
abstract class SplineSeriesMarker implements Built<SplineSeriesMarker, SplineSeriesMarkerBuilder> {
  static Serializer<SplineSeriesMarker> get serializer => _$splineSeriesMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
   ...
   */
  @nullable
  SplineSeriesMarkerStates get states;
  /** 
   * <p>A predefined shape or symbol for the marker. When null, the symbol is pulled from options.symbols. Other possible values are "circle", "square", "diamond", "triangle" and "triangle-down".</p>
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory SplineSeriesMarker([updates(SplineSeriesMarkerBuilder b)]) = _$SplineSeriesMarker;
  SplineSeriesMarker._();
}
abstract class SplineSeriesMarkerStates implements Built<SplineSeriesMarkerStates, SplineSeriesMarkerStatesBuilder> {
  static Serializer<SplineSeriesMarkerStates> get serializer => _$splineSeriesMarkerStatesSerializer;
  /** 
   * null 
   */
  @nullable
  SplineSeriesMarkerStatesHover get hover;
  /** 
   * The appearance of the point marker when selected. In order to allow a point to be 
		selected, set the <code>series.allowPointSelect</code> option to true. 
   */
  @nullable
  SplineSeriesMarkerStatesSelect get select;
  factory SplineSeriesMarkerStates([updates(SplineSeriesMarkerStatesBuilder b)]) = _$SplineSeriesMarkerStates;
  SplineSeriesMarkerStates._();
}
abstract class SplineSeriesMarkerStatesHover implements Built<SplineSeriesMarkerStatesHover, SplineSeriesMarkerStatesHoverBuilder> {
  static Serializer<SplineSeriesMarkerStatesHover> get serializer => _$splineSeriesMarkerStatesHoverSerializer;
  /** 
  ...
  @nullable
  num get radiusPlus;
  factory SplineSeriesMarkerStatesHover([updates(SplineSeriesMarkerStatesHoverBuilder b)]) = _$SplineSeriesMarkerStatesHover;
  SplineSeriesMarkerStatesHover._();
}
abstract class SplineSeriesMarkerStatesSelect implements Built<SplineSeriesMarkerStatesSelect, SplineSeriesMarkerStatesSelectBuilder> {
  static Serializer<SplineSeriesMarkerStatesSelect> get serializer => _$splineSeriesMarkerStatesSelectSerializer;
  /** 
  ...
  @nullable
  num get radius;
  factory SplineSeriesMarkerStatesSelect([updates(SplineSeriesMarkerStatesSelectBuilder b)]) = _$SplineSeriesMarkerStatesSelect;
  SplineSeriesMarkerStatesSelect._();
}
abstract class SplineSeriesPoint implements Built<SplineSeriesPoint, SplineSeriesPointBuilder> {
  static Serializer<SplineSeriesPoint> get serializer => _$splineSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  SplineSeriesPointEvents get events;
  factory SplineSeriesPoint([updates(SplineSeriesPointBuilder b)]) = _$SplineSeriesPoint;
  SplineSeriesPoint._();
}
abstract class SplineSeriesPointEvents implements Built<SplineSeriesPointEvents, SplineSeriesPointEventsBuilder> {
  static Serializer<SplineSeriesPointEvents> get serializer => _$splineSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory SplineSeriesPointEvents([updates(SplineSeriesPointEventsBuilder b)]) = _$SplineSeriesPointEvents;
  SplineSeriesPointEvents._();
}
abstract class SplineSeriesStates implements Built<SplineSeriesStates, SplineSeriesStatesBuilder> {
  static Serializer<SplineSeriesStates> get serializer => _$splineSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  SplineSeriesStatesHover get hover;
  factory SplineSeriesStates([updates(SplineSeriesStatesBuilder b)]) = _$SplineSeriesStates;
  SplineSeriesStates._();
}
abstract class SplineSeriesStatesHover implements Built<SplineSeriesStatesHover, SplineSeriesStatesHoverBuilder> {
  static Serializer<SplineSeriesStatesHover> get serializer => _$splineSeriesStatesHoverSerializer;
  /** 
   * Animation setting for hovering the graph in line-type series. 
   */
  @nullable
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  SplineSeriesStatesHoverMarker get marker;
  @deprecated
  factory SplineSeriesStatesHover([updates(SplineSeriesStatesHoverBuilder b)]) = _$SplineSeriesStatesHover;
  SplineSeriesStatesHover._();
}
abstract class SplineSeriesStatesHoverHalo implements Built<SplineSeriesStatesHoverHalo, SplineSeriesStatesHoverHaloBuilder> {
  static Serializer<SplineSeriesStatesHoverHalo> get serializer => _$splineSeriesStatesHoverHaloSerializer;
  /** 
   * A collection of SVG attributes to override the appearance of the halo, for example <code>fill</code>, <code>stroke</code> and <code>stroke-width</code>. 
   */
  @nullable
  ...
  @nullable
  num get size;
  factory SplineSeriesStatesHoverHalo([updates(SplineSeriesStatesHoverHaloBuilder b)]) = _$SplineSeriesStatesHoverHalo;
  SplineSeriesStatesHoverHalo._();
}
abstract class SplineSeriesStatesHoverMarker implements Built<SplineSeriesStatesHoverMarker, SplineSeriesStatesHoverMarkerBuilder> {
  static Serializer<SplineSeriesStatesHoverMarker> get serializer => _$splineSeriesStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory SplineSeriesStatesHoverMarker([updates(SplineSeriesStatesHoverMarkerBuilder b)]) = _$SplineSeriesStatesHoverMarker;
  SplineSeriesStatesHoverMarker._();
}
abstract class SplineSeriesTooltip implements Built<SplineSeriesTooltip, SplineSeriesTooltipBuilder> {
  static Serializer<SplineSeriesTooltip> get serializer => _$splineSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory SplineSeriesTooltip([updates(SplineSeriesTooltipBuilder b)]) = _$SplineSeriesTooltip;
  SplineSeriesTooltip._();
}
abstract class SplineSeriesZones implements Built<SplineSeriesZones, SplineSeriesZonesBuilder> {
  static Serializer<SplineSeriesZones> get serializer => _$splineSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory SplineSeriesZones([updates(SplineSeriesZonesBuilder b)]) = _$SplineSeriesZones;
  SplineSeriesZones._();
}
