...
part 'areaspline_series.g.dart';
    
abstract class AreasplineSeries implements Series, Built<AreasplineSeries, AreasplineSeriesBuilder> {
  static Serializer<AreasplineSeries> get serializer => _$areasplineSeriesSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the data labels can be styled wtih the <code>.highcharts-data-label-box</code> and <code>.highcharts-data-label</code> class names (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">see example</a>).</p> 
   */
  @nullable
  AreasplineSeriesDataLabels get dataLabels;
  /** 
...
<p>A description of the series to add to the screen reader information about the series.</p> 
   ...
   */
  @nullable
  AreasplineSeriesEvents get events;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the markers can be styled with the <code>.highcharts-point</code>, <code>.highcharts-point-hover</code> and <code>.highcharts-point-select</code> class names.</p> 
   */
  @nullable
  AreasplineSeriesMarker get marker;
  /** 
   ...
   */
  @nullable
  AreasplineSeriesPoint get point;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the color zones are styled with the <code>.highcharts-zone-{n}</code> class, or custom classed from the <code>className</code> option (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/color-zones/">view live demo</a>).</p> 
  ...
  factory AreasplineSeries([updates(AreasplineSeriesBuilder b)]) = _$AreasplineSeries;
  AreasplineSeries._();
}
abstract class AreasplineSeriesData implements Built<AreasplineSeriesData, AreasplineSeriesDataBuilder> {
  static Serializer<AreasplineSeriesData> get serializer => _$areasplineSeriesDataSerializer;
  /** 
...
<p>A description of the point to add to the screen reader information about the point.</p> 
   ...
   */
  @nullable
  AreasplineSeriesDataMarker get marker;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory AreasplineSeriesData([updates(AreasplineSeriesDataBuilder b)]) = _$AreasplineSeriesData;
  AreasplineSeriesData._();
}
abstract class AreasplineSeriesDataEvents implements Built<AreasplineSeriesDataEvents, AreasplineSeriesDataEventsBuilder> {
  static Serializer<AreasplineSeriesDataEvents> get serializer => _$areasplineSeriesDataEventsSerializer;
  /** 
  ...
  factory AreasplineSeriesDataEvents([updates(AreasplineSeriesDataEventsBuilder b)]) = _$AreasplineSeriesDataEvents;
  AreasplineSeriesDataEvents._();
}
abstract class AreasplineSeriesDataMarker implements Built<AreasplineSeriesDataMarker, AreasplineSeriesDataMarkerBuilder> {
  static Serializer<AreasplineSeriesDataMarker> get serializer => _$areasplineSeriesDataMarkerSerializer;
  /** 
   ...
   */
  @nullable
  AreasplineSeriesDataMarkerStates get states;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreasplineSeriesDataMarker([updates(AreasplineSeriesDataMarkerBuilder b)]) = _$AreasplineSeriesDataMarker;
  AreasplineSeriesDataMarker._();
}
abstract class AreasplineSeriesDataMarkerStates implements Built<AreasplineSeriesDataMarkerStates, AreasplineSeriesDataMarkerStatesBuilder> {
  static Serializer<AreasplineSeriesDataMarkerStates> get serializer => _$areasplineSeriesDataMarkerStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  AreasplineSeriesDataMarkerStatesHover get hover;
  factory AreasplineSeriesDataMarkerStates([updates(AreasplineSeriesDataMarkerStatesBuilder b)]) = _$AreasplineSeriesDataMarkerStates;
  AreasplineSeriesDataMarkerStates._();
}
abstract class AreasplineSeriesDataMarkerStatesHover implements Built<AreasplineSeriesDataMarkerStatesHover, AreasplineSeriesDataMarkerStatesHoverBuilder> {
  static Serializer<AreasplineSeriesDataMarkerStatesHover> get serializer => _$areasplineSeriesDataMarkerStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  AreasplineSeriesDataMarkerStatesHoverMarker get marker;
  @deprecated
  factory AreasplineSeriesDataMarkerStatesHover([updates(AreasplineSeriesDataMarkerStatesHoverBuilder b)]) = _$AreasplineSeriesDataMarkerStatesHover;
  AreasplineSeriesDataMarkerStatesHover._();
}
abstract class AreasplineSeriesDataMarkerStatesHoverHalo implements Built<AreasplineSeriesDataMarkerStatesHoverHalo, AreasplineSeriesDataMarkerStatesHoverHaloBuilder> {
  static Serializer<AreasplineSeriesDataMarkerStatesHoverHalo> get serializer => _$areasplineSeriesDataMarkerStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory AreasplineSeriesDataMarkerStatesHoverHalo([updates(AreasplineSeriesDataMarkerStatesHoverHaloBuilder b)]) = _$AreasplineSeriesDataMarkerStatesHoverHalo;
  AreasplineSeriesDataMarkerStatesHoverHalo._();
}
abstract class AreasplineSeriesDataMarkerStatesHoverMarker implements Built<AreasplineSeriesDataMarkerStatesHoverMarker, AreasplineSeriesDataMarkerStatesHoverMarkerBuilder> {
  static Serializer<AreasplineSeriesDataMarkerStatesHoverMarker> get serializer => _$areasplineSeriesDataMarkerStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreasplineSeriesDataMarkerStatesHoverMarker([updates(AreasplineSeriesDataMarkerStatesHoverMarkerBuilder b)]) = _$AreasplineSeriesDataMarkerStatesHoverMarker;
  AreasplineSeriesDataMarkerStatesHoverMarker._();
}
abstract class AreasplineSeriesDataLabels implements Built<AreasplineSeriesDataLabels, AreasplineSeriesDataLabelsBuilder> {
  static Serializer<AreasplineSeriesDataLabels> get serializer => _$areasplineSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory AreasplineSeriesDataLabels([updates(AreasplineSeriesDataLabelsBuilder b)]) = _$AreasplineSeriesDataLabels;
  AreasplineSeriesDataLabels._();
}
abstract class AreasplineSeriesEvents implements Built<AreasplineSeriesEvents, AreasplineSeriesEventsBuilder> {
  static Serializer<AreasplineSeriesEvents> get serializer => _$areasplineSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory AreasplineSeriesEvents([updates(AreasplineSeriesEventsBuilder b)]) = _$AreasplineSeriesEvents;
  AreasplineSeriesEvents._();
}
abstract class AreasplineSeriesMarker implements Built<AreasplineSeriesMarker, AreasplineSeriesMarkerBuilder> {
  static Serializer<AreasplineSeriesMarker> get serializer => _$areasplineSeriesMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
   ...
   */
  @nullable
  AreasplineSeriesMarkerStates get states;
  /** 
   * <p>A predefined shape or symbol for the marker. When null, the symbol is pulled from options.symbols. Other possible values are "circle", "square", "diamond", "triangle" and "triangle-down".</p>
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreasplineSeriesMarker([updates(AreasplineSeriesMarkerBuilder b)]) = _$AreasplineSeriesMarker;
  AreasplineSeriesMarker._();
}
abstract class AreasplineSeriesMarkerStates implements Built<AreasplineSeriesMarkerStates, AreasplineSeriesMarkerStatesBuilder> {
  static Serializer<AreasplineSeriesMarkerStates> get serializer => _$areasplineSeriesMarkerStatesSerializer;
  /** 
   * null 
   */
  @nullable
  AreasplineSeriesMarkerStatesHover get hover;
  /** 
   * The appearance of the point marker when selected. In order to allow a point to be 
		selected, set the <code>series.allowPointSelect</code> option to true. 
   */
  @nullable
  AreasplineSeriesMarkerStatesSelect get select;
  factory AreasplineSeriesMarkerStates([updates(AreasplineSeriesMarkerStatesBuilder b)]) = _$AreasplineSeriesMarkerStates;
  AreasplineSeriesMarkerStates._();
}
abstract class AreasplineSeriesMarkerStatesHover implements Built<AreasplineSeriesMarkerStatesHover, AreasplineSeriesMarkerStatesHoverBuilder> {
  static Serializer<AreasplineSeriesMarkerStatesHover> get serializer => _$areasplineSeriesMarkerStatesHoverSerializer;
  /** 
  ...
  @nullable
  num get radiusPlus;
  factory AreasplineSeriesMarkerStatesHover([updates(AreasplineSeriesMarkerStatesHoverBuilder b)]) = _$AreasplineSeriesMarkerStatesHover;
  AreasplineSeriesMarkerStatesHover._();
}
abstract class AreasplineSeriesMarkerStatesSelect implements Built<AreasplineSeriesMarkerStatesSelect, AreasplineSeriesMarkerStatesSelectBuilder> {
  static Serializer<AreasplineSeriesMarkerStatesSelect> get serializer => _$areasplineSeriesMarkerStatesSelectSerializer;
  /** 
  ...
  @nullable
  num get radius;
  factory AreasplineSeriesMarkerStatesSelect([updates(AreasplineSeriesMarkerStatesSelectBuilder b)]) = _$AreasplineSeriesMarkerStatesSelect;
  AreasplineSeriesMarkerStatesSelect._();
}
abstract class AreasplineSeriesPoint implements Built<AreasplineSeriesPoint, AreasplineSeriesPointBuilder> {
  static Serializer<AreasplineSeriesPoint> get serializer => _$areasplineSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  AreasplineSeriesPointEvents get events;
  factory AreasplineSeriesPoint([updates(AreasplineSeriesPointBuilder b)]) = _$AreasplineSeriesPoint;
  AreasplineSeriesPoint._();
}
abstract class AreasplineSeriesPointEvents implements Built<AreasplineSeriesPointEvents, AreasplineSeriesPointEventsBuilder> {
  static Serializer<AreasplineSeriesPointEvents> get serializer => _$areasplineSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory AreasplineSeriesPointEvents([updates(AreasplineSeriesPointEventsBuilder b)]) = _$AreasplineSeriesPointEvents;
  AreasplineSeriesPointEvents._();
}
abstract class AreasplineSeriesStates implements Built<AreasplineSeriesStates, AreasplineSeriesStatesBuilder> {
  static Serializer<AreasplineSeriesStates> get serializer => _$areasplineSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  AreasplineSeriesStatesHover get hover;
  factory AreasplineSeriesStates([updates(AreasplineSeriesStatesBuilder b)]) = _$AreasplineSeriesStates;
  AreasplineSeriesStates._();
}
abstract class AreasplineSeriesStatesHover implements Built<AreasplineSeriesStatesHover, AreasplineSeriesStatesHoverBuilder> {
  static Serializer<AreasplineSeriesStatesHover> get serializer => _$areasplineSeriesStatesHoverSerializer;
  /** 
   * Animation setting for hovering the graph in line-type series. 
   */
  @nullable
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  AreasplineSeriesStatesHoverMarker get marker;
  @deprecated
  factory AreasplineSeriesStatesHover([updates(AreasplineSeriesStatesHoverBuilder b)]) = _$AreasplineSeriesStatesHover;
  AreasplineSeriesStatesHover._();
}
abstract class AreasplineSeriesStatesHoverHalo implements Built<AreasplineSeriesStatesHoverHalo, AreasplineSeriesStatesHoverHaloBuilder> {
  static Serializer<AreasplineSeriesStatesHoverHalo> get serializer => _$areasplineSeriesStatesHoverHaloSerializer;
  /** 
   * A collection of SVG attributes to override the appearance of the halo, for example <code>fill</code>, <code>stroke</code> and <code>stroke-width</code>. 
   */
  @nullable
  ...
  @nullable
  num get size;
  factory AreasplineSeriesStatesHoverHalo([updates(AreasplineSeriesStatesHoverHaloBuilder b)]) = _$AreasplineSeriesStatesHoverHalo;
  AreasplineSeriesStatesHoverHalo._();
}
abstract class AreasplineSeriesStatesHoverMarker implements Built<AreasplineSeriesStatesHoverMarker, AreasplineSeriesStatesHoverMarkerBuilder> {
  static Serializer<AreasplineSeriesStatesHoverMarker> get serializer => _$areasplineSeriesStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory AreasplineSeriesStatesHoverMarker([updates(AreasplineSeriesStatesHoverMarkerBuilder b)]) = _$AreasplineSeriesStatesHoverMarker;
  AreasplineSeriesStatesHoverMarker._();
}
abstract class AreasplineSeriesTooltip implements Built<AreasplineSeriesTooltip, AreasplineSeriesTooltipBuilder> {
  static Serializer<AreasplineSeriesTooltip> get serializer => _$areasplineSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory AreasplineSeriesTooltip([updates(AreasplineSeriesTooltipBuilder b)]) = _$AreasplineSeriesTooltip;
  AreasplineSeriesTooltip._();
}
abstract class AreasplineSeriesZones implements Built<AreasplineSeriesZones, AreasplineSeriesZonesBuilder> {
  static Serializer<AreasplineSeriesZones> get serializer => _$areasplineSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory AreasplineSeriesZones([updates(AreasplineSeriesZonesBuilder b)]) = _$AreasplineSeriesZones;
  AreasplineSeriesZones._();
}
