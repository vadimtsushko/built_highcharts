...
part 'polygon_series.g.dart';
    
abstract class PolygonSeries implements Series, Built<PolygonSeries, PolygonSeriesBuilder> {
  static Serializer<PolygonSeries> get serializer => _$polygonSeriesSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the data labels can be styled wtih the <code>.highcharts-data-label-box</code> and <code>.highcharts-data-label</code> class names (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">see example</a>).</p> 
   */
  @nullable
  PolygonSeriesDataLabels get dataLabels;
  /** 
...
<p>A description of the series to add to the screen reader information about the series.</p> 
   ...
   */
  @nullable
  PolygonSeriesEvents get events;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the markers can be styled with the <code>.highcharts-point</code>, <code>.highcharts-point-hover</code> and <code>.highcharts-point-select</code> class names.</p> 
   */
  @nullable
  PolygonSeriesMarker get marker;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the color zones are styled with the <code>.highcharts-zone-{n}</code> class, or custom classed from the <code>className</code> option (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/color-zones/">view live demo</a>).</p> 
  ...
  factory PolygonSeries([updates(PolygonSeriesBuilder b)]) = _$PolygonSeries;
  PolygonSeries._();
}
abstract class PolygonSeriesData implements Built<PolygonSeriesData, PolygonSeriesDataBuilder> {
  static Serializer<PolygonSeriesData> get serializer => _$polygonSeriesDataSerializer;
  /** 
...
<p>A description of the point to add to the screen reader information about the point.</p> 
   ...
   */
  @nullable
  PolygonSeriesDataMarker get marker;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory PolygonSeriesData([updates(PolygonSeriesDataBuilder b)]) = _$PolygonSeriesData;
  PolygonSeriesData._();
}
abstract class PolygonSeriesDataEvents implements Built<PolygonSeriesDataEvents, PolygonSeriesDataEventsBuilder> {
  static Serializer<PolygonSeriesDataEvents> get serializer => _$polygonSeriesDataEventsSerializer;
  /** 
  ...
  factory PolygonSeriesDataEvents([updates(PolygonSeriesDataEventsBuilder b)]) = _$PolygonSeriesDataEvents;
  PolygonSeriesDataEvents._();
}
abstract class PolygonSeriesDataMarker implements Built<PolygonSeriesDataMarker, PolygonSeriesDataMarkerBuilder> {
  static Serializer<PolygonSeriesDataMarker> get serializer => _$polygonSeriesDataMarkerSerializer;
  /** 
   ...
   */
  @nullable
  PolygonSeriesDataMarkerStates get states;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory PolygonSeriesDataMarker([updates(PolygonSeriesDataMarkerBuilder b)]) = _$PolygonSeriesDataMarker;
  PolygonSeriesDataMarker._();
}
abstract class PolygonSeriesDataMarkerStates implements Built<PolygonSeriesDataMarkerStates, PolygonSeriesDataMarkerStatesBuilder> {
  static Serializer<PolygonSeriesDataMarkerStates> get serializer => _$polygonSeriesDataMarkerStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  PolygonSeriesDataMarkerStatesHover get hover;
  factory PolygonSeriesDataMarkerStates([updates(PolygonSeriesDataMarkerStatesBuilder b)]) = _$PolygonSeriesDataMarkerStates;
  PolygonSeriesDataMarkerStates._();
}
abstract class PolygonSeriesDataMarkerStatesHover implements Built<PolygonSeriesDataMarkerStatesHover, PolygonSeriesDataMarkerStatesHoverBuilder> {
  static Serializer<PolygonSeriesDataMarkerStatesHover> get serializer => _$polygonSeriesDataMarkerStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  PolygonSeriesDataMarkerStatesHoverMarker get marker;
  @deprecated
  factory PolygonSeriesDataMarkerStatesHover([updates(PolygonSeriesDataMarkerStatesHoverBuilder b)]) = _$PolygonSeriesDataMarkerStatesHover;
  PolygonSeriesDataMarkerStatesHover._();
}
abstract class PolygonSeriesDataMarkerStatesHoverHalo implements Built<PolygonSeriesDataMarkerStatesHoverHalo, PolygonSeriesDataMarkerStatesHoverHaloBuilder> {
  static Serializer<PolygonSeriesDataMarkerStatesHoverHalo> get serializer => _$polygonSeriesDataMarkerStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory PolygonSeriesDataMarkerStatesHoverHalo([updates(PolygonSeriesDataMarkerStatesHoverHaloBuilder b)]) = _$PolygonSeriesDataMarkerStatesHoverHalo;
  PolygonSeriesDataMarkerStatesHoverHalo._();
}
abstract class PolygonSeriesDataMarkerStatesHoverMarker implements Built<PolygonSeriesDataMarkerStatesHoverMarker, PolygonSeriesDataMarkerStatesHoverMarkerBuilder> {
  static Serializer<PolygonSeriesDataMarkerStatesHoverMarker> get serializer => _$polygonSeriesDataMarkerStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory PolygonSeriesDataMarkerStatesHoverMarker([updates(PolygonSeriesDataMarkerStatesHoverMarkerBuilder b)]) = _$PolygonSeriesDataMarkerStatesHoverMarker;
  PolygonSeriesDataMarkerStatesHoverMarker._();
}
abstract class PolygonSeriesDataLabels implements Built<PolygonSeriesDataLabels, PolygonSeriesDataLabelsBuilder> {
  static Serializer<PolygonSeriesDataLabels> get serializer => _$polygonSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory PolygonSeriesDataLabels([updates(PolygonSeriesDataLabelsBuilder b)]) = _$PolygonSeriesDataLabels;
  PolygonSeriesDataLabels._();
}
abstract class PolygonSeriesEvents implements Built<PolygonSeriesEvents, PolygonSeriesEventsBuilder> {
  static Serializer<PolygonSeriesEvents> get serializer => _$polygonSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory PolygonSeriesEvents([updates(PolygonSeriesEventsBuilder b)]) = _$PolygonSeriesEvents;
  PolygonSeriesEvents._();
}
abstract class PolygonSeriesMarker implements Built<PolygonSeriesMarker, PolygonSeriesMarkerBuilder> {
  static Serializer<PolygonSeriesMarker> get serializer => _$polygonSeriesMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
   ...
   */
  @nullable
  PolygonSeriesMarkerStates get states;
  /** 
   * <p>A predefined shape or symbol for the marker. When null, the symbol is pulled from options.symbols. Other possible values are "circle", "square", "diamond", "triangle" and "triangle-down".</p>
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory PolygonSeriesMarker([updates(PolygonSeriesMarkerBuilder b)]) = _$PolygonSeriesMarker;
  PolygonSeriesMarker._();
}
abstract class PolygonSeriesMarkerStates implements Built<PolygonSeriesMarkerStates, PolygonSeriesMarkerStatesBuilder> {
  static Serializer<PolygonSeriesMarkerStates> get serializer => _$polygonSeriesMarkerStatesSerializer;
  /** 
   * null 
   */
  @nullable
  PolygonSeriesMarkerStatesHover get hover;
  /** 
   * The appearance of the point marker when selected. In order to allow a point to be 
		selected, set the <code>series.allowPointSelect</code> option to true. 
   */
  @nullable
  PolygonSeriesMarkerStatesSelect get select;
  factory PolygonSeriesMarkerStates([updates(PolygonSeriesMarkerStatesBuilder b)]) = _$PolygonSeriesMarkerStates;
  PolygonSeriesMarkerStates._();
}
abstract class PolygonSeriesMarkerStatesHover implements Built<PolygonSeriesMarkerStatesHover, PolygonSeriesMarkerStatesHoverBuilder> {
  static Serializer<PolygonSeriesMarkerStatesHover> get serializer => _$polygonSeriesMarkerStatesHoverSerializer;
  /** 
  ...
  @nullable
  num get radiusPlus;
  factory PolygonSeriesMarkerStatesHover([updates(PolygonSeriesMarkerStatesHoverBuilder b)]) = _$PolygonSeriesMarkerStatesHover;
  PolygonSeriesMarkerStatesHover._();
}
abstract class PolygonSeriesMarkerStatesSelect implements Built<PolygonSeriesMarkerStatesSelect, PolygonSeriesMarkerStatesSelectBuilder> {
  static Serializer<PolygonSeriesMarkerStatesSelect> get serializer => _$polygonSeriesMarkerStatesSelectSerializer;
  /** 
  ...
  @nullable
  num get radius;
  factory PolygonSeriesMarkerStatesSelect([updates(PolygonSeriesMarkerStatesSelectBuilder b)]) = _$PolygonSeriesMarkerStatesSelect;
  PolygonSeriesMarkerStatesSelect._();
}
abstract class PolygonSeriesPoint implements Built<PolygonSeriesPoint, PolygonSeriesPointBuilder> {
  static Serializer<PolygonSeriesPoint> get serializer => _$polygonSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  PolygonSeriesPointEvents get events;
  factory PolygonSeriesPoint([updates(PolygonSeriesPointBuilder b)]) = _$PolygonSeriesPoint;
  PolygonSeriesPoint._();
}
abstract class PolygonSeriesPointEvents implements Built<PolygonSeriesPointEvents, PolygonSeriesPointEventsBuilder> {
  static Serializer<PolygonSeriesPointEvents> get serializer => _$polygonSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory PolygonSeriesPointEvents([updates(PolygonSeriesPointEventsBuilder b)]) = _$PolygonSeriesPointEvents;
  PolygonSeriesPointEvents._();
}
abstract class PolygonSeriesStates implements Built<PolygonSeriesStates, PolygonSeriesStatesBuilder> {
  static Serializer<PolygonSeriesStates> get serializer => _$polygonSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  PolygonSeriesStatesHover get hover;
  factory PolygonSeriesStates([updates(PolygonSeriesStatesBuilder b)]) = _$PolygonSeriesStates;
  PolygonSeriesStates._();
}
abstract class PolygonSeriesStatesHover implements Built<PolygonSeriesStatesHover, PolygonSeriesStatesHoverBuilder> {
  static Serializer<PolygonSeriesStatesHover> get serializer => _$polygonSeriesStatesHoverSerializer;
  /** 
   * Animation setting for hovering the graph in line-type series. 
   */
  @nullable
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  PolygonSeriesStatesHoverMarker get marker;
  @deprecated
  factory PolygonSeriesStatesHover([updates(PolygonSeriesStatesHoverBuilder b)]) = _$PolygonSeriesStatesHover;
  PolygonSeriesStatesHover._();
}
abstract class PolygonSeriesStatesHoverHalo implements Built<PolygonSeriesStatesHoverHalo, PolygonSeriesStatesHoverHaloBuilder> {
  static Serializer<PolygonSeriesStatesHoverHalo> get serializer => _$polygonSeriesStatesHoverHaloSerializer;
  /** 
   * A collection of SVG attributes to override the appearance of the halo, for example <code>fill</code>, <code>stroke</code> and <code>stroke-width</code>. 
   */
  @nullable
  ...
  @nullable
  num get size;
  factory PolygonSeriesStatesHoverHalo([updates(PolygonSeriesStatesHoverHaloBuilder b)]) = _$PolygonSeriesStatesHoverHalo;
  PolygonSeriesStatesHoverHalo._();
}
abstract class PolygonSeriesStatesHoverMarker implements Built<PolygonSeriesStatesHoverMarker, PolygonSeriesStatesHoverMarkerBuilder> {
  static Serializer<PolygonSeriesStatesHoverMarker> get serializer => _$polygonSeriesStatesHoverMarkerSerializer;
  /** 
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data is dense, and shown for more widespread data points. 
   */
  @nullable
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory PolygonSeriesStatesHoverMarker([updates(PolygonSeriesStatesHoverMarkerBuilder b)]) = _$PolygonSeriesStatesHoverMarker;
  PolygonSeriesStatesHoverMarker._();
}
abstract class PolygonSeriesTooltip implements Built<PolygonSeriesTooltip, PolygonSeriesTooltipBuilder> {
  static Serializer<PolygonSeriesTooltip> get serializer => _$polygonSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory PolygonSeriesTooltip([updates(PolygonSeriesTooltipBuilder b)]) = _$PolygonSeriesTooltip;
  PolygonSeriesTooltip._();
}
abstract class PolygonSeriesZones implements Built<PolygonSeriesZones, PolygonSeriesZonesBuilder> {
  static Serializer<PolygonSeriesZones> get serializer => _$polygonSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory PolygonSeriesZones([updates(PolygonSeriesZonesBuilder b)]) = _$PolygonSeriesZones;
  PolygonSeriesZones._();
}
