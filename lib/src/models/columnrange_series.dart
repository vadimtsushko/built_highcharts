...
abstract class ColumnrangeSeries implements Series, Built<ColumnrangeSeries, ColumnrangeSeriesBuilder> {
  static Serializer<ColumnrangeSeries> get serializer => _$columnrangeSeriesSerializer;
  /** 
...
<p>A description of the series to add to the screen reader information about the series.</p> 
   ...
   */
  @nullable
  ColumnrangeSeriesEvents get events;
  /** 
...
<p>Applies only to series types using nearest neighbor search (not direct hover) for tooltip.</p>  
   ...
   */
  @nullable
  ColumnrangeSeriesPoint get point;
  /** 
...
abstract class ColumnrangeSeriesData implements Built<ColumnrangeSeriesData, ColumnrangeSeriesDataBuilder> {
  static Serializer<ColumnrangeSeriesData> get serializer => _$columnrangeSeriesDataSerializer;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get x;
  factory ColumnrangeSeriesData([updates(ColumnrangeSeriesDataBuilder b)]) = _$ColumnrangeSeriesData;
  ColumnrangeSeriesData._();
}
abstract class ColumnrangeSeriesDataEvents implements Built<ColumnrangeSeriesDataEvents, ColumnrangeSeriesDataEventsBuilder> {
  static Serializer<ColumnrangeSeriesDataEvents> get serializer => _$columnrangeSeriesDataEventsSerializer;
  /** 
  ...
  factory ColumnrangeSeriesDataEvents([updates(ColumnrangeSeriesDataEventsBuilder b)]) = _$ColumnrangeSeriesDataEvents;
  ColumnrangeSeriesDataEvents._();
}
abstract class ColumnrangeSeriesDataLabels implements Built<ColumnrangeSeriesDataLabels, ColumnrangeSeriesDataLabelsBuilder> {
  static Serializer<ColumnrangeSeriesDataLabels> get serializer => _$columnrangeSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory ColumnrangeSeriesDataLabels([updates(ColumnrangeSeriesDataLabelsBuilder b)]) = _$ColumnrangeSeriesDataLabels;
  ColumnrangeSeriesDataLabels._();
}
abstract class ColumnrangeSeriesEvents implements Built<ColumnrangeSeriesEvents, ColumnrangeSeriesEventsBuilder> {
  static Serializer<ColumnrangeSeriesEvents> get serializer => _$columnrangeSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory ColumnrangeSeriesEvents([updates(ColumnrangeSeriesEventsBuilder b)]) = _$ColumnrangeSeriesEvents;
  ColumnrangeSeriesEvents._();
}
abstract class ColumnrangeSeriesPoint implements Built<ColumnrangeSeriesPoint, ColumnrangeSeriesPointBuilder> {
  static Serializer<ColumnrangeSeriesPoint> get serializer => _$columnrangeSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  ColumnrangeSeriesPointEvents get events;
  factory ColumnrangeSeriesPoint([updates(ColumnrangeSeriesPointBuilder b)]) = _$ColumnrangeSeriesPoint;
  ColumnrangeSeriesPoint._();
}
abstract class ColumnrangeSeriesPointEvents implements Built<ColumnrangeSeriesPointEvents, ColumnrangeSeriesPointEventsBuilder> {
  static Serializer<ColumnrangeSeriesPointEvents> get serializer => _$columnrangeSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory ColumnrangeSeriesPointEvents([updates(ColumnrangeSeriesPointEventsBuilder b)]) = _$ColumnrangeSeriesPointEvents;
  ColumnrangeSeriesPointEvents._();
}
abstract class ColumnrangeSeriesStates implements Built<ColumnrangeSeriesStates, ColumnrangeSeriesStatesBuilder> {
  static Serializer<ColumnrangeSeriesStates> get serializer => _$columnrangeSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  ColumnrangeSeriesStatesHover get hover;
  factory ColumnrangeSeriesStates([updates(ColumnrangeSeriesStatesBuilder b)]) = _$ColumnrangeSeriesStates;
  ColumnrangeSeriesStates._();
}
abstract class ColumnrangeSeriesStatesHover implements Built<ColumnrangeSeriesStatesHover, ColumnrangeSeriesStatesHoverBuilder> {
  static Serializer<ColumnrangeSeriesStatesHover> get serializer => _$columnrangeSeriesStatesHoverSerializer;
  /** 
...
abstract class ColumnrangeSeriesStatesHoverHalo implements Built<ColumnrangeSeriesStatesHoverHalo, ColumnrangeSeriesStatesHoverHaloBuilder> {
  static Serializer<ColumnrangeSeriesStatesHoverHalo> get serializer => _$columnrangeSeriesStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory ColumnrangeSeriesStatesHoverHalo([updates(ColumnrangeSeriesStatesHoverHaloBuilder b)]) = _$ColumnrangeSeriesStatesHoverHalo;
  ColumnrangeSeriesStatesHoverHalo._();
}
abstract class ColumnrangeSeriesTooltip implements Built<ColumnrangeSeriesTooltip, ColumnrangeSeriesTooltipBuilder> {
  static Serializer<ColumnrangeSeriesTooltip> get serializer => _$columnrangeSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory ColumnrangeSeriesTooltip([updates(ColumnrangeSeriesTooltipBuilder b)]) = _$ColumnrangeSeriesTooltip;
  ColumnrangeSeriesTooltip._();
}
abstract class ColumnrangeSeriesZones implements Built<ColumnrangeSeriesZones, ColumnrangeSeriesZonesBuilder> {
  static Serializer<ColumnrangeSeriesZones> get serializer => _$columnrangeSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory ColumnrangeSeriesZones([updates(ColumnrangeSeriesZonesBuilder b)]) = _$ColumnrangeSeriesZones;
  ColumnrangeSeriesZones._();
}
