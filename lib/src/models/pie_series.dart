...
abstract class PieSeries implements Series, Built<PieSeries, PieSeriesBuilder> {
  static Serializer<PieSeries> get serializer => _$pieSeriesSerializer;
  /** 
...
<pre>data: [{
   ...
   */
  @nullable
  PieSeriesDataLabels get dataLabels;
  /** 
...
abstract class PieSeriesData implements Built<PieSeriesData, PieSeriesDataBuilder> {
  static Serializer<PieSeriesData> get serializer => _$pieSeriesDataSerializer;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory PieSeriesData([updates(PieSeriesDataBuilder b)]) = _$PieSeriesData;
  PieSeriesData._();
}
abstract class PieSeriesDataEvents implements Built<PieSeriesDataEvents, PieSeriesDataEventsBuilder> {
  static Serializer<PieSeriesDataEvents> get serializer => _$pieSeriesDataEventsSerializer;
  /** 
  ...
  factory PieSeriesDataEvents([updates(PieSeriesDataEventsBuilder b)]) = _$PieSeriesDataEvents;
  PieSeriesDataEvents._();
}
abstract class PieSeriesDataLabels implements Built<PieSeriesDataLabels, PieSeriesDataLabelsBuilder> {
  static Serializer<PieSeriesDataLabels> get serializer => _$pieSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory PieSeriesDataLabels([updates(PieSeriesDataLabelsBuilder b)]) = _$PieSeriesDataLabels;
  PieSeriesDataLabels._();
}
abstract class PieSeriesEvents implements Built<PieSeriesEvents, PieSeriesEventsBuilder> {
  static Serializer<PieSeriesEvents> get serializer => _$pieSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory PieSeriesEvents([updates(PieSeriesEventsBuilder b)]) = _$PieSeriesEvents;
  PieSeriesEvents._();
}
abstract class PieSeriesPoint implements Built<PieSeriesPoint, PieSeriesPointBuilder> {
  static Serializer<PieSeriesPoint> get serializer => _$pieSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  PieSeriesPointEvents get events;
  factory PieSeriesPoint([updates(PieSeriesPointBuilder b)]) = _$PieSeriesPoint;
  PieSeriesPoint._();
}
abstract class PieSeriesPointEvents implements Built<PieSeriesPointEvents, PieSeriesPointEventsBuilder> {
  static Serializer<PieSeriesPointEvents> get serializer => _$pieSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory PieSeriesPointEvents([updates(PieSeriesPointEventsBuilder b)]) = _$PieSeriesPointEvents;
  PieSeriesPointEvents._();
}
abstract class PieSeriesStates implements Built<PieSeriesStates, PieSeriesStatesBuilder> {
  static Serializer<PieSeriesStates> get serializer => _$pieSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  PieSeriesStatesHover get hover;
  factory PieSeriesStates([updates(PieSeriesStatesBuilder b)]) = _$PieSeriesStates;
  PieSeriesStates._();
}
abstract class PieSeriesStatesHover implements Built<PieSeriesStatesHover, PieSeriesStatesHoverBuilder> {
  static Serializer<PieSeriesStatesHover> get serializer => _$pieSeriesStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  PieSeriesStatesHoverMarker get marker;
  @deprecated
  factory PieSeriesStatesHover([updates(PieSeriesStatesHoverBuilder b)]) = _$PieSeriesStatesHover;
  PieSeriesStatesHover._();
}
abstract class PieSeriesStatesHoverHalo implements Built<PieSeriesStatesHoverHalo, PieSeriesStatesHoverHaloBuilder> {
  static Serializer<PieSeriesStatesHoverHalo> get serializer => _$pieSeriesStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory PieSeriesStatesHoverHalo([updates(PieSeriesStatesHoverHaloBuilder b)]) = _$PieSeriesStatesHoverHalo;
  PieSeriesStatesHoverHalo._();
}
abstract class PieSeriesStatesHoverMarker implements Built<PieSeriesStatesHoverMarker, PieSeriesStatesHoverMarkerBuilder> {
  static Serializer<PieSeriesStatesHoverMarker> get serializer => _$pieSeriesStatesHoverMarkerSerializer;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory PieSeriesStatesHoverMarker([updates(PieSeriesStatesHoverMarkerBuilder b)]) = _$PieSeriesStatesHoverMarker;
  PieSeriesStatesHoverMarker._();
}
abstract class PieSeriesTooltip implements Built<PieSeriesTooltip, PieSeriesTooltipBuilder> {
  static Serializer<PieSeriesTooltip> get serializer => _$pieSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory PieSeriesTooltip([updates(PieSeriesTooltipBuilder b)]) = _$PieSeriesTooltip;
  PieSeriesTooltip._();
}
abstract class PieSeriesZones implements Built<PieSeriesZones, PieSeriesZonesBuilder> {
  static Serializer<PieSeriesZones> get serializer => _$pieSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory PieSeriesZones([updates(PieSeriesZonesBuilder b)]) = _$PieSeriesZones;
  PieSeriesZones._();
}
