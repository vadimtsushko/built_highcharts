...
<pre>data: [{
   ...
   */
  @nullable
  FunnelSeriesDataLabels get dataLabels;
  /** 
...
abstract class FunnelSeriesData implements Built<FunnelSeriesData, FunnelSeriesDataBuilder> {
  static Serializer<FunnelSeriesData> get serializer => _$funnelSeriesDataSerializer;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get y;
  factory FunnelSeriesData([updates(FunnelSeriesDataBuilder b)]) = _$FunnelSeriesData;
  FunnelSeriesData._();
}
abstract class FunnelSeriesDataEvents implements Built<FunnelSeriesDataEvents, FunnelSeriesDataEventsBuilder> {
  static Serializer<FunnelSeriesDataEvents> get serializer => _$funnelSeriesDataEventsSerializer;
  /** 
  ...
  factory FunnelSeriesDataEvents([updates(FunnelSeriesDataEventsBuilder b)]) = _$FunnelSeriesDataEvents;
  FunnelSeriesDataEvents._();
}
abstract class FunnelSeriesDataLabels implements Built<FunnelSeriesDataLabels, FunnelSeriesDataLabelsBuilder> {
  static Serializer<FunnelSeriesDataLabels> get serializer => _$funnelSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory FunnelSeriesDataLabels([updates(FunnelSeriesDataLabelsBuilder b)]) = _$FunnelSeriesDataLabels;
  FunnelSeriesDataLabels._();
}
abstract class FunnelSeriesEvents implements Built<FunnelSeriesEvents, FunnelSeriesEventsBuilder> {
  static Serializer<FunnelSeriesEvents> get serializer => _$funnelSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory FunnelSeriesEvents([updates(FunnelSeriesEventsBuilder b)]) = _$FunnelSeriesEvents;
  FunnelSeriesEvents._();
}
abstract class FunnelSeriesPoint implements Built<FunnelSeriesPoint, FunnelSeriesPointBuilder> {
  static Serializer<FunnelSeriesPoint> get serializer => _$funnelSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  FunnelSeriesPointEvents get events;
  factory FunnelSeriesPoint([updates(FunnelSeriesPointBuilder b)]) = _$FunnelSeriesPoint;
  FunnelSeriesPoint._();
}
abstract class FunnelSeriesPointEvents implements Built<FunnelSeriesPointEvents, FunnelSeriesPointEventsBuilder> {
  static Serializer<FunnelSeriesPointEvents> get serializer => _$funnelSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory FunnelSeriesPointEvents([updates(FunnelSeriesPointEventsBuilder b)]) = _$FunnelSeriesPointEvents;
  FunnelSeriesPointEvents._();
}
abstract class FunnelSeriesStates implements Built<FunnelSeriesStates, FunnelSeriesStatesBuilder> {
  static Serializer<FunnelSeriesStates> get serializer => _$funnelSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  FunnelSeriesStatesHover get hover;
  factory FunnelSeriesStates([updates(FunnelSeriesStatesBuilder b)]) = _$FunnelSeriesStates;
  FunnelSeriesStates._();
}
abstract class FunnelSeriesStatesHover implements Built<FunnelSeriesStatesHover, FunnelSeriesStatesHoverBuilder> {
  static Serializer<FunnelSeriesStatesHover> get serializer => _$funnelSeriesStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  FunnelSeriesStatesHoverMarker get marker;
  @deprecated
  factory FunnelSeriesStatesHover([updates(FunnelSeriesStatesHoverBuilder b)]) = _$FunnelSeriesStatesHover;
  FunnelSeriesStatesHover._();
}
abstract class FunnelSeriesStatesHoverHalo implements Built<FunnelSeriesStatesHoverHalo, FunnelSeriesStatesHoverHaloBuilder> {
  static Serializer<FunnelSeriesStatesHoverHalo> get serializer => _$funnelSeriesStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory FunnelSeriesStatesHoverHalo([updates(FunnelSeriesStatesHoverHaloBuilder b)]) = _$FunnelSeriesStatesHoverHalo;
  FunnelSeriesStatesHoverHalo._();
}
abstract class FunnelSeriesStatesHoverMarker implements Built<FunnelSeriesStatesHoverMarker, FunnelSeriesStatesHoverMarkerBuilder> {
  static Serializer<FunnelSeriesStatesHoverMarker> get serializer => _$funnelSeriesStatesHoverMarkerSerializer;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory FunnelSeriesStatesHoverMarker([updates(FunnelSeriesStatesHoverMarkerBuilder b)]) = _$FunnelSeriesStatesHoverMarker;
  FunnelSeriesStatesHoverMarker._();
}
abstract class FunnelSeriesTooltip implements Built<FunnelSeriesTooltip, FunnelSeriesTooltipBuilder> {
  static Serializer<FunnelSeriesTooltip> get serializer => _$funnelSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory FunnelSeriesTooltip([updates(FunnelSeriesTooltipBuilder b)]) = _$FunnelSeriesTooltip;
  FunnelSeriesTooltip._();
}
abstract class FunnelSeriesZones implements Built<FunnelSeriesZones, FunnelSeriesZonesBuilder> {
  static Serializer<FunnelSeriesZones> get serializer => _$funnelSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory FunnelSeriesZones([updates(FunnelSeriesZonesBuilder b)]) = _$FunnelSeriesZones;
  FunnelSeriesZones._();
}
