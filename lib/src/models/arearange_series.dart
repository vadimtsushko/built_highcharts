...
part 'arearange_series.g.dart';
    
abstract class ArearangeSeries implements Series, Built<ArearangeSeries, ArearangeSeriesBuilder> {
  static Serializer<ArearangeSeries> get serializer => _$arearangeSeriesSerializer;
  /** 
...
<p>A description of the series to add to the screen reader information about the series.</p> 
   ...
   */
  @nullable
  ArearangeSeriesEvents get events;
  /** 
...
<p>Applies only to series types using nearest neighbor search (not direct hover) for tooltip.</p>  
   ...
   */
  @nullable
  ArearangeSeriesPoint get point;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the color zones are styled with the <code>.highcharts-zone-{n}</code> class, or custom classed from the <code>className</code> option (<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/color-zones/">view live demo</a>).</p> 
  ...
  factory ArearangeSeries([updates(ArearangeSeriesBuilder b)]) = _$ArearangeSeries;
  ArearangeSeries._();
}
abstract class ArearangeSeriesData implements Built<ArearangeSeriesData, ArearangeSeriesDataBuilder> {
  static Serializer<ArearangeSeriesData> get serializer => _$arearangeSeriesDataSerializer;
  /** 
...
<p>If the <a href="#xAxis.type">xAxis.type</a> is set to <code>category</code>, and no <a href="#xAxis.categories">categories</a> option exists, the category will be pulled from the <code>point.name</code> of the last series defined. For multiple series, best practice however is to define <code>xAxis.categories</code>.</p> 
  ...
  @nullable
  num get x;
  factory ArearangeSeriesData([updates(ArearangeSeriesDataBuilder b)]) = _$ArearangeSeriesData;
  ArearangeSeriesData._();
}
abstract class ArearangeSeriesDataEvents implements Built<ArearangeSeriesDataEvents, ArearangeSeriesDataEventsBuilder> {
  static Serializer<ArearangeSeriesDataEvents> get serializer => _$arearangeSeriesDataEventsSerializer;
  /** 
  ...
  factory ArearangeSeriesDataEvents([updates(ArearangeSeriesDataEventsBuilder b)]) = _$ArearangeSeriesDataEvents;
  ArearangeSeriesDataEvents._();
}
abstract class ArearangeSeriesDataLabels implements Built<ArearangeSeriesDataLabels, ArearangeSeriesDataLabelsBuilder> {
  static Serializer<ArearangeSeriesDataLabels> get serializer => _$arearangeSeriesDataLabelsSerializer;
  /** 
...
<tr>
  ...
  @nullable
  num get zIndex;
  factory ArearangeSeriesDataLabels([updates(ArearangeSeriesDataLabelsBuilder b)]) = _$ArearangeSeriesDataLabels;
  ArearangeSeriesDataLabels._();
}
abstract class ArearangeSeriesEvents implements Built<ArearangeSeriesEvents, ArearangeSeriesEventsBuilder> {
  static Serializer<ArearangeSeriesEvents> get serializer => _$arearangeSeriesEventsSerializer;
  /** 
  ...
  @nullable
  Function get show;
  factory ArearangeSeriesEvents([updates(ArearangeSeriesEventsBuilder b)]) = _$ArearangeSeriesEvents;
  ArearangeSeriesEvents._();
}
abstract class ArearangeSeriesPoint implements Built<ArearangeSeriesPoint, ArearangeSeriesPointBuilder> {
  static Serializer<ArearangeSeriesPoint> get serializer => _$arearangeSeriesPointSerializer;
  /** 
   * Events for each single point 
   */
  @nullable
  ArearangeSeriesPointEvents get events;
  factory ArearangeSeriesPoint([updates(ArearangeSeriesPointBuilder b)]) = _$ArearangeSeriesPoint;
  ArearangeSeriesPoint._();
}
abstract class ArearangeSeriesPointEvents implements Built<ArearangeSeriesPointEvents, ArearangeSeriesPointEventsBuilder> {
  static Serializer<ArearangeSeriesPointEvents> get serializer => _$arearangeSeriesPointEventsSerializer;
  /** 
   * <p></p>Fires when a point is clicked. One parameter, <code>event</code>, is passed to the function. This contains common event information based on jQuery or MooTools depending on  which library is used as the base for Highcharts.<p></p> <p>If the <code>series.allowPointSelect</code> option is true, the default action for the point's click event is to toggle the point's select state. Returning <code>false</code> cancels this action.</p> 
   */
  @nullable
  ...
  @nullable
  Function get update_;
  factory ArearangeSeriesPointEvents([updates(ArearangeSeriesPointEventsBuilder b)]) = _$ArearangeSeriesPointEvents;
  ArearangeSeriesPointEvents._();
}
abstract class ArearangeSeriesStates implements Built<ArearangeSeriesStates, ArearangeSeriesStatesBuilder> {
  static Serializer<ArearangeSeriesStates> get serializer => _$arearangeSeriesStatesSerializer;
  /** 
   * Options for the hovered series 
   */
  @nullable
  ArearangeSeriesStatesHover get hover;
  factory ArearangeSeriesStates([updates(ArearangeSeriesStatesBuilder b)]) = _$ArearangeSeriesStates;
  ArearangeSeriesStates._();
}
abstract class ArearangeSeriesStatesHover implements Built<ArearangeSeriesStatesHover, ArearangeSeriesStatesHoverBuilder> {
  static Serializer<ArearangeSeriesStatesHover> get serializer => _$arearangeSeriesStatesHoverSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the halo is styled with the <code>.highcharts-halo</code> class, with colors inherited from <code>.highcharts-color-{n}</code>.</p> 
  ...
  @deprecated
  @nullable
  ArearangeSeriesStatesHoverMarker get marker;
  @deprecated
  factory ArearangeSeriesStatesHover([updates(ArearangeSeriesStatesHoverBuilder b)]) = _$ArearangeSeriesStatesHover;
  ArearangeSeriesStatesHover._();
}
abstract class ArearangeSeriesStatesHoverHalo implements Built<ArearangeSeriesStatesHoverHalo, ArearangeSeriesStatesHoverHaloBuilder> {
  static Serializer<ArearangeSeriesStatesHoverHalo> get serializer => _$arearangeSeriesStatesHoverHaloSerializer;
  /** 
  ...
  @nullable
  num get size;
  factory ArearangeSeriesStatesHoverHalo([updates(ArearangeSeriesStatesHoverHaloBuilder b)]) = _$ArearangeSeriesStatesHoverHalo;
  ArearangeSeriesStatesHoverHalo._();
}
abstract class ArearangeSeriesStatesHoverMarker implements Built<ArearangeSeriesStatesHoverMarker, ArearangeSeriesStatesHoverMarkerBuilder> {
  static Serializer<ArearangeSeriesStatesHoverMarker> get serializer => _$arearangeSeriesStatesHoverMarkerSerializer;
  /** 
...
<p>Custom callbacks for symbol path generation can also be added to <code>Highcharts.SVGRenderer.prototype.symbols</code>. The callback is then used by its method name, as shown in the demo.</p> 
  ...
  @nullable
  num get width;
  factory ArearangeSeriesStatesHoverMarker([updates(ArearangeSeriesStatesHoverMarkerBuilder b)]) = _$ArearangeSeriesStatesHoverMarker;
  ArearangeSeriesStatesHoverMarker._();
}
abstract class ArearangeSeriesTooltip implements Built<ArearangeSeriesTooltip, ArearangeSeriesTooltipBuilder> {
  static Serializer<ArearangeSeriesTooltip> get serializer => _$arearangeSeriesTooltipSerializer;
  /** 
...
<p>In <a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">styled mode</a>, the dot is colored by a class name rather than the point color.</p> 
  ...
  factory ArearangeSeriesTooltip([updates(ArearangeSeriesTooltipBuilder b)]) = _$ArearangeSeriesTooltip;
  ArearangeSeriesTooltip._();
}
abstract class ArearangeSeriesZones implements Built<ArearangeSeriesZones, ArearangeSeriesZonesBuilder> {
  static Serializer<ArearangeSeriesZones> get serializer => _$arearangeSeriesZonesSerializer;
  /** 
  ...
  @nullable
  num get value;
  factory ArearangeSeriesZones([updates(ArearangeSeriesZonesBuilder b)]) = _$ArearangeSeriesZones;
  ArearangeSeriesZones._();
}
